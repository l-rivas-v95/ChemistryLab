...
public final class AmmoniumSmilesCatalog {
    ...
    private static void halides(Map<String, String> smilesByFormula) {
        register(smilesByFormula, "NH4F", AMMONIUM + ".[F-]", "FH4N");
        register(smilesByFormula, "NH4Cl", AMMONIUM + ".[Cl-]", "ClH4N");
        register(smilesByFormula, "NH4Br", AMMONIUM + ".[Br-]", "BrH4N");
        register(smilesByFormula, "NH4I", AMMONIUM + ".[I-]", "H4IN");
    }

    private static void oxosalts(Map<String, String> smilesByFormula) {
        register(smilesByFormula, "NH4NO3", AMMONIUM + ".[O-][N+](=O)[O-]", "H4N2O3", "H4NNO3");
        register(smilesByFormula, "(NH4)2SO4", AMMONIUM + "." + AMMONIUM + ".[O-]S(=O)(=O)[O-]", "H8N2O4S");
        register(smilesByFormula, "(NH4)3PO4", AMMONIUM + "." + AMMONIUM + "." + AMMONIUM + ".[O-]P(=O)([O-])[O-]", "H12N3O4P");
    }

    private static void hydroxide(Map<String, String> smilesByFormula) {
        register(smilesByFormula, "NH4OH", AMMONIUM + ".[OH-]", "H5NO");
    }
}
